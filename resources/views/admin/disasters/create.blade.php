                ...
                <form action="{{ route('backend.disasters.store') }}"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <select id="disasterType"
                                    ...
                                    <option value="Flood"
                                        {{ old('type') == 'Flood' ? 'selected' : '' }}>
                                        ရေကြီးရေလျှံမှု
                                    </option>

                                    <option value="Earthquake"
                                        {{ old('type') == 'Earthquake' ? 'selected' : '' }}>
                                        ငလျင်
                                    </option>

                                    <option value="Cyclone"
                                        {{ old('type') == 'Cyclone' ? 'selected' : '' }}>
                                        မုန်တိုင်း
                                    </option>

                                    <option value="Landslide"
                                        {{ old('type') == 'Landslide' ? 'selected' : '' }}>
                                        မြေပြိုမှု
                                    </option>

                                    <option value="Fire"
                                        {{ old('type') == 'Fire' ? 'selected' : '' }}>
                                        မီးလောင်မှု
                                    </option>

                                    <option value="Drought"
                                        {{ old('type') == 'Drought' ? 'selected' : '' }}>
                                        မိုးခေါင်မှု
                                    </option>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <button type="submit"
                            ...
                            ဘေးအန္တရာယ်ဖြစ်ရပ် သိမ်းဆည်းရန်
                        </button>
