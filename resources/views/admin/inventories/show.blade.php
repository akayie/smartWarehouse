...
<div class="card">
    ...
    <div style="display:grid; grid-template-columns:1fr 1fr; gap:20px; margin-bottom:25px;">
        ...
        <div style="border:1px solid #e5e7eb; border-radius:8px; padding:18px; background:#ffffff;">
            ...
            <h4
                style="margin:0 0 14px; padding-bottom:8px; border-bottom:1px solid #f3f4f6; color:#374151;"
            >
    ...
    <div
        style="display:flex; gap:20px; font-size:13px; color:#6b7280; padding-top:15px; border-top:1px solid #e5e7eb;"
    >
        ...
        <div>
            ...
            {{ $inventory->updated_at
                ? $inventory->updated_at->format('M d, Y H:i A')
                : 'N/A'
            }}
    ...
    <!-- Action Buttons -->
    <div
        style="display:flex; gap:10px; margin-top:25px; padding-top:20px; border-top:1px solid #e5e7eb;"
    >
