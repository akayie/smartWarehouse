...
@section('title', 'ပစ္စည်းပြင်ဆင်ရန် - ' . $item->name)
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea
                                ...
                                id="description"
                                rows="3"
                                placeholder="ပစ္စည်းအကြောင်းအရာကို ထည့်သွင်းပါ"
...
<script>
    ...
    startButton.addEventListener('click', function () {
        ...
        barcodeScanner.start(
            ...
            alert(
                'ကင်မရာအသုံးပြုခွင့် မရရှိပါ။ HTTPS ချိတ်ဆက်မှု လိုအပ်နိုင်ပါသည်။'
            );
