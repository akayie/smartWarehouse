            ...
            <form method="GET" action="{{ route('backend.items.index') }}" class="row g-2 align-items-center">
                ...
                <div class="col-md-4">
                    <input
                        ...
                        class="form-control"
                        placeholder="ပစ္စည်းအမည်  ရှာဖွေရန်..."
                    >
                </div>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <thead class="table-light">
                        ...
                        <tr>
                            ...
                            <th>အမျိုးအစား</th>
                            {{-- <th>စျေးနှုန်း</th> --}}
                            <th>စုစုပေါင်းလက်ကျန်</th>
                            <th>အနည်းဆုံးလက်ကျန်</th>
                            <th>ယူနစ်</th>
                            <th>အခြေအနေ</th>
                            <th class="text-end pe-3">လုပ်ဆောင်ချက်များ</th>
                                ...
                                <td class="text-end pe-3">
                                    ...
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        <form
                                            ...
                                            method="POST"
                                            onsubmit="return confirm('ဤပစ္စည်းကို ဖျက်ရန် သေချာပါသလား?');"
                                            class="d-inline"
                                        >
